...
public class MyController {
	...
	public String MainPage(HttpServletRequest req, Model model, SearchCriteria scri) throws Exception {
		...
		@ResponseBody
		public List<ReplyDto> MainReplypage(@RequestParam int board_no, Model model) throws Exception{
			
			System.out.println("MainReplyView");
			System.out.println(board_no);		
			return rReplyService.commentList();
		}
