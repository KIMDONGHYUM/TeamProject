...
<body>
    	...
    	<div id="wrapper">
    		...
    		<form action="modify_1on1Action" method="POST" enctype="multipart/form-data">
    		<div id="notice">
    			<h4><b>1대1 문의</b></h4>
    			...
    			<input type="hidden" name="board_no" value="${ view_1on1.board_no } ">
    				<tr>
	    				<th>제목</th><td><input type="text" size=70 name="title" value="${view_1on1.title}"></td>
	    			</tr>
    				...
    				<tr>
    					<th>내용</th><td><textarea id = "editor4" name = "editor4" name="Upload" cols="80" rows="20" placeholder="${view_1on1.content}"></textarea></td>
    			...
    			<div id="btns">
    				...
    				<input type="button" class="btn btn-primary" value="취소" onclick="javascript:window.location='1on1'">
				</div>    		
    		</div>
    		</form>
    	</div>
